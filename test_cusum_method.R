###QUESTIONS;
# scales          lag2_total_rainfall_ab = scale(lag2_total_rainfall_ab), but not lag 3. 
#is this needed for model?..many variables scaled in 00_format_input_data.R
...
form1 <- 'derivCumsum_hold ~ 1 +  lag3_cum_rain + lag3_temp +   f(t, model = "ar1", constr=T) + 
                                 f(time_id2, model = "ar1", constr=T,replicate = districtID2) + 
