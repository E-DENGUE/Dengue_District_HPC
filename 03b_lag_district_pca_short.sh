...
#SBATCH -o ./Report/output03b/output03.%a.out # STDOUT
#SBATCH --array=1-9408   # If k models and J hold out time points this is 1- j*k  J=84 times, k=112 districts array should be i*j*k
...
Rscript ./R/03b_call_lag_district_pca_short.R "$j" "$k" "$i"
...
echo "j=$j, k=$k, i=$i, district_number=$task_id, running_time=$running_time seconds" >> ./Report/log3b.txt
# done